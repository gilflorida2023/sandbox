...
| `workspace/specs/*.md` (44 chapters) + `index.json` | **GFM language specification** — an *additional/reference* spec, NOT the project. Drives `gfm.SpecExampleTest`. Do not read all by default. |
...
- `workspace/specs/*.md` + `index.json` — ingested GFM language spec (reference data)
